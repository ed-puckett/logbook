...
export class MenuBar {
    ...
    #build_menu(menu_spec, parent, toplevel=false) {
        ...
        if (item) {
            ...
            if (!toplevel) {
                ...
                el.innerText = '\u25b8';  // right-pointing triangle
                el.classList.add('menuitem-annotation', 'collection-arrow');
            }
    ...
    #build_menuitem(label, toplevel=false) {
        ...
        lbl.classList.add('menuitem-label');
        lbl.innerText = label;
    ...
    #add_item_menuitem_annotations_and_click_handler(menuitem, command) {
        if (command) {
            ...
            if (kbd_bindings) {
                ...
                kbd_container.classList.add('menuitem-annotation');
    ...
    #build_menubar(parent, menubar_spec) {
        ...
        menubar_container.classList.add('active', 'menubar'),
